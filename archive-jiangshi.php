					...
					<div class="container">
						...
						<?php
							...
							for($i=0;$i<count($request);$i++){
								...
								// echo '</div></div></div>';
								$class=str_replace(","," ",($request[$i][edu_class]));
								//echo $class;
								//echo strpos($class,'导师专家');
								if(strpos($class,'导师专家')){
								echo '<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">';
								echo '<div class="team-block">';
								echo '<figure class="team-img">';
								echo '<img src="'.$request[$i][thumb].'" alt="">';
								echo '</figure>';
								echo '<h3 class="team-title">';
								echo '<a href="'.$request[$i][url].'">'.$request[$i][title].'</a>';
								echo '</h3>';
								echo '<p class="team-subtitle">'.$request[$i][zhicheng].'</p>';
								echo '</div>';
								echo '</div>';
								}
							}
