...
<html >
    <head>
        ...
        <?php if (!empty($this->options->CDNURL)): ?>
            <link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->CDNURL() ?>/MaterialCDN/css/bootstrap.min.css" />
            <link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->CDNURL() ?>/MaterialCDN/css/font-awesome.min.css" />
			<link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->CDNURL() ?>/MaterialCDN/css/china.css" />
        <?php else: ?>
            <link rel="stylesheet" type="text/css" media="all" href="https://cdn.staticfile.org/twitter-bootstrap/3.3.7/css/bootstrap.min.css" />
            <link rel="stylesheet" type="text/css" media="all" href="https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.min.css" />
			<link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->themeUrl('css/china.css'); ?>" />
        <?php endif; ?>
